  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <p className={styles.description}>
        Glavni problem je nedovoljno razvijena ljudska svest i nemogućnost ljudi da sagledaju situaciju na duže staze; Ljudima je bitno da njihov život bude ugodan, a da pritom ne misle na buduće generacije, zato se i ne vodi računa o prirodi i ljudi bacaju smeće gde stignu, uništavaju se šume radi izgradnje industrijskih objekata, puteva itd. U ovu kategoriju takođe spadaju automobili, ali sa pojavom električnih automobila ocekujemo da će zagađenje biti znacajno manje. Previše uzimamo od prirode, ne nudeći ništa za uzvrat, tako kršeći zakon ravnoteže koji je ključan da bi se održao život, ljudi uzimaju daleko više nego što im je potrebno da bi nahranili svoj ego ili ispunili duševnu prazninu. Po meni takvo ponašanje može dovesti u pitanje opstanak ljudske vrste jer su prirodni resursi ograničeni i ako svi budu uzimali više nego sto im je potrebno uništiće prirodu u celini. Smatram da situacija koja se trenutno odigrava u svetu, u vezi sa pandemijom COVID 19 virusom opominje ljude da čuvaju prirodu.
        </p>
        ...
        <p className={styles.description}>
          ...
          Po mom mišljenju jedini pravi način da zaustavimo zagađenje je da se razvije ljudska svest i da ljudi sami budu spremni da preduzmu nešto povodom zagađenja, ako uspemo da razvijemo pozitivne stavove o očuvanju sredine, ti stavovi će se prenositi kroz generacije što je mnogo efikasnije od trenutnog rešenja dobrovoljnih akcija sakupljanja smeća, filtera…
          <br/>
